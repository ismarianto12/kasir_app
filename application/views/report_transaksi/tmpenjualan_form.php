...
<div class="row clearfix">
     ...
     ** ) Harap Isikan data yang di butuhkan pada form.
	 ...
	 <div class="form-group">
            <label for="varchar" class='control-label col-md-3'><b>Kasir Id<?php echo form_error('kasir_id') ?></b></label>
            <div class='col-md-9'>
            <input type="text" class="form-control" name="kasir_id" id="kasir_id" placeholder="Kasir Id" value="<?php echo $kasir_id; ?>" />
        </div>
    </div>
	 <div class="form-group">
            <label for="varchar" class='control-label col-md-3'><b>Barang Id<?php echo form_error('barang_id') ?></b></label>
            <div class='col-md-9'>
	 ...
	 <div class="form-group">
            <label for="decimal" class='control-label col-md-3'><b>Price<?php echo form_error('price') ?></b></label>
            <div class='col-md-9'>
