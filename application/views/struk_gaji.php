...
<div id="payslip">
  <div id="title">Slip Gaji , BOUTIQUE GIABAI</div>
  <div id="scope">
    <div class="scope-entry">
      <div class="title">Tanggal Sekarang</div>
      <div class="value"><?= date('Y-m-d') ?></div>
    </div>
    <div class="scope-entry">
      <div class="title">Periode </div>
      <div class="value"><?= $period_sampai ?></div>
    </div>
  </div>
  <div class="content">
    <div class="left-panel">
      <div id="employee">
        <div id="name"><?= $namakaryawan ?>
        </div>
        <div id="email"> 
         <?= $email ?>
        </div>
      ...
      <div class="details">
        <div class="entry">
          ...
          <div class="value"><?= $karyawan_id ?></div>
        </div>

        <div class="entry">
          <div class="label">GAJI PERBULAN</div>
          <div class="value"><?= number_format($gajipokok,0,0,'.') ?></div>
        </div>
        <div class="net_pay">
          <div class="entry">
            ...
            <div class="rate"></div>
            <div class="amount"><?= number_format($gajipokok,0,0,'.') ?></div>
          </div>
        </div>
      </div>
    </div>
